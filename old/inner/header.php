  ...
  <body>
    ...
    <div class= "container header">
      <div class ="row">
        ...
        <a name="jumpToTop"></a>
          <a href= "index.php" alt= "logo"><span id= "logo" class="textLeft leftFloat">herdOfElephants</span></a>
        </div>
        <div class= "col-md-10 col-xs-10">
          <ul class= "list-unstyled list-inline">
            ...
            <li><a href="http://feeds.feedburner.com/HerdOfElephants" target="_blank"><i class="fa fa-rss-square fontAwesomeAttrs" aria-hidden="true"></i></a></li>
        ...
        <div class= "col-md-1 col-xs-1">
          <a href= "http://www.herdofelephants.com/resume/" alt="resume"><span id= "resume" class="textRight rightFloat">[resume]</span></a>
        </div>
      </div>
    </div>
